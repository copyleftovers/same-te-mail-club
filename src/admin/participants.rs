                            ...
                            if list.is_empty() {
                                view! {
                                    <div class="empty-state" data-testid="empty-state">
                                        ...
                                        <p class="empty-state-body">Учасники зʼявляться після реєстрації</p>
                                    </div>
                                }
                                    .into_any()
                            } else {
...
/// Admin participants management page (legacy standalone page).
///
/// The unified admin page (`page.rs`) is the primary entry point.
/// This component is retained for the standalone `/admin/participants` route.
#[component]
