...
- Deactivated phones are silently redirected before reaching the invite-code step; this prevents the unique-constraint error from revealing that the phone is registered
